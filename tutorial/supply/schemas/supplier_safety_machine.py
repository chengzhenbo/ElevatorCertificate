...
class SafetyMachineBase(BaseModel):
...
class SafetyMachineCreate(SafetyMachineBase):
...
class SafetyMachineInDBBase(SafetyMachineBase):
...
class SafetyMachine(SafetyMachineInDBBase):
    pass

class ListSafetyMachines(BaseModel):
