...
from schemas.supplier_smart_board import SmartBoardCreateSchema, ListSmartBoardSchema
from api import deps

router = APIRouter()

@router.post('/smartboad', response_model = ListSmartBoardSchema, status_code=status.HTTP_201_CREATED)
