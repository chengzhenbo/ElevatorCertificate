...
Revision ID: 58a4863d21a4
Revises: b86346127f99
Create Date: 2023-08-13 14:33:16.884424
...
revision = '58a4863d21a4'
down_revision = 'b86346127f99'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.drop_index('ix_supplier_safety_device_safety_device_id', table_name='supplier_safety_device')
    op.drop_table('supplier_safety_device')
    op.drop_index('ix_supplier_brake_brake_id', table_name='supplier_brake')
...
def downgrade() -> None:
    ...
    sa.Column('brake_id', sa.VARCHAR(), nullable=False),
    sa.Column('contract_no', sa.VARCHAR(), nullable=True),
    sa.Column('dept_name', sa.VARCHAR(length=100), nullable=True),
    sa.Column('product_type_name', sa.VARCHAR(length=100), nullable=True),
    sa.Column('product_model', sa.VARCHAR(length=100), nullable=True),
    sa.Column('product_no', sa.VARCHAR(length=100), nullable=True),
    sa.Column('product_testing_cert_no', sa.VARCHAR(length=100), nullable=True),
    sa.Column('manufacture_date', sa.DATE(), nullable=True),
    sa.Column('create_time', sa.DATETIME(), nullable=False),
    sa.Column('update_time', sa.DATETIME(), nullable=False),
    sa.Column('user_id', sa.BIGINT(), nullable=True),
    sa.Column('data_state', sa.VARCHAR(length=10), nullable=True),
    sa.Column('remark', sa.VARCHAR(length=100), nullable=True),
    sa.PrimaryKeyConstraint('brake_id')
    )
    op.create_index('ix_supplier_brake_brake_id', 'supplier_brake', ['brake_id'], unique=False)
    op.create_table('supplier_safety_device',
    sa.Column('safety_device_id', sa.VARCHAR(), nullable=False),
    sa.Column('contract_no', sa.VARCHAR(), nullable=True),
    sa.Column('dept_name', sa.VARCHAR(length=100), nullable=True),
    sa.Column('product_type_name', sa.VARCHAR(length=100), nullable=True),
    sa.Column('product_model', sa.VARCHAR(length=100), nullable=True),
    ...
    op.create_index('ix_supplier_safety_device_safety_device_id', 'supplier_safety_device', ['safety_device_id'], unique=False)
