...
class ParseJson:
    ...
    def extract_product(self)->None:
        ...
        if 'ModelReadinHgzCsZjb' in self.data and (len(self.data['ModelReadinHgzCsZjb'])>0):
    ...
    def extract_tech_para(self)->None:
        ...
        if 'ModelReadinHgzCsZjb' in self.data and (len(self.data['ModelReadinHgzCsZjb'])>0):
            ...
            tech_para['door_open_mode'] = ParseJson.norm_door_openmethod(self.data['ModelReadinHgzCsZjb']['开门方式'])
    ...
    def extract_ropehead(self)->None:
        ...
        if 'SupplierRopeHead' in self.data and (len(self.data['SupplierRopeHead'])>0):
    ...
    def extract_drivecontroller(self)->None:
        ...
        if 'SupplierDriveController' in self.data and (len(self.data['SupplierDriveController'])>0):
    ...
    def extract_controlcabinet_doorsystem(self)->None:
        ...
        if 'SupplierKongZhiGuiMenXiTongs' in self.data and (len(self.data['SupplierKongZhiGuiMenXiTongs'])>0):
    ...
    def extract_board(self)->None:
        ...
        if 'SupplierSmartBoard' in self.data and (len(self.data['SupplierSmartBoard'])>0):
        ...
        if 'SupplierLvct1Board' in self.data and (len(self.data['SupplierLvct1Board'])>0):
    ...
    def extract_steel_rope(self)->None:
        ...
        if 'SupplierSteelRope' in self.data and (len(self.data['SupplierSteelRope'])>0):
    ...
    def extract_cabin_safety(self)->None:
        ...
        if 'SupplierCabinUpOPs' in self.data and (len(self.data['SupplierCabinUpOPs'])>0):
        ...
        if 'SupplierCabinUnMPs' in self.data and (len(self.data['SupplierCabinUnMPs'])>0):
    ...
    def extract_speed_limiter(self)->None:
        ...
        if 'SupplierSpeedLimiters' in self.data and (len(self.data['SupplierSpeedLimiters'])>0):
    ...
    def extract_safebrake(self)->None:
        ...
        if 'SupplierSafeBrakes' in self.data and (len(self.data['SupplierSafeBrakes'])>0):
    ...
    def extract_buffer(self)->None:
        ...
        if 'SupplierBuffers' in self.data and (len(self.data['SupplierBuffers'])>0):
    ...
    @classmethod
    def norm_door_openmethod(cls, origial_method:str)->str:
        """"""
        map_strings = {'中分式':'中分', 
                       '双折式右开':'旁开双折', 
                       '中分式双折':'中分双折',
                       '双折式左开':'旁开双折'}
        if origial_method in map_strings:
            return map_strings[origial_method]
        else:
            return origial_method